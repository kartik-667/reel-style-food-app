    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center mb-8 select-none">
          <div className="h-10 w-10 rounded-2xl bg-black text-white grid place-items-center font-bold">F</div>
          <span className="ml-3 text-xl font-semibold tracking-tight text-slate-900">FoodPartner</span>
        </div>

        {/* Card */}
        <div className="bg-white rounded-2xl shadow-lg shadow-slate-200/60 border border-slate-200">
          <div className="p-8">
            <h1 className="text-2xl font-bold text-slate-900">Register as a Partner</h1>
            ...
            <form className="mt-6 grid gap-5">
              ...
              {/* Contact Name */}
              <div className="grid gap-2">
                <label htmlFor="contactname" className="text-sm font-medium text-slate-700">Contact Person</label>
                <input
                  id="contactname"
                  name="contactname"
                  type="text"
        ...
        <p className="mt-6 text-center text-sm text-slate-600">
          ...
          <Link to="/foodpartner/login" className="font-semibold text-slate-900 hover:underline">Log in as Business</Link>
        </p>
      </div>
    </div>
  );
