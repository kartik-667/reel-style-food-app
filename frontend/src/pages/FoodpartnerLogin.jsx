      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg shadow-slate-200/60 border border-slate-200">
          <div className="p-8">
            ...
            <p className="mt-1 text-sm text-slate-500">Sign in to your Food partner account.</p>
        ...
        <p className="mt-6 text-center text-sm text-slate-600">
          ...
          <Link to='/foodpartner/register' className="font-semibold text-slate-900 hover:underline"> Register Now as Business</Link>
        </p>
      </div>
    </div>
  );
